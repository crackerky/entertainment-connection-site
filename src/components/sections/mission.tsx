          ...
          <Accordion.Root type="multiple" className="space-y-4">
            {faqs.map((faq) => (
              ...
              >
                ...
                >
                  <Accordion.Trigger className="w-full px-6 py-6 text-left flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-opacity-50 rounded-2xl group">
                    <h3 className="text-lg font-semibold text-gray-900 pr-4">
                      {faq.question}
                    </h3>
                    <ChevronDown className="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0 group-data-[state=open]:rotate-180" />
                  </Accordion.Trigger>
